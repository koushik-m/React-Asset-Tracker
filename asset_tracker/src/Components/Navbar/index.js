  ...
  render () {
    return (
      <div className="navbar">
        <Link className="active" to="/user"><i className="fa fa-fw fa-home"></i> Assets-Tracker</Link>
        ...
        <Link className="link" to="/"><Button btnprop='btn btn-danger'>Log out</Button></Link>
      </div>
    )
  }
}
